...
enum opcodetype
{
	...
	OP_IDENTITY_NEW = 0x01,
	OP_IDENTITY_DELETE = 0x02,
    OP_IDENTITY_PAYMENT = 0x03,
    OP_IDENTITY_ACTIVATE=0x04,
    OP_IDENTITY_UPDATE=0x05,
	OP_IDENTITY_MULTISIG = 0x06,
	OP_IDENTITY_FEEDBACK = 0x07,

    // distributed exchange
    OP_OFFER_ACTIVATE = 0xd1,
    OP_OFFER_UPDATE = 0xd2,
    OP_OFFER_ACCEPT = 0xd3,
    OP_OFFER_ACCEPT_FEEDBACK = 0xd4,
