...
public:
    explicit OfferAcceptDialogBTC(WalletModel* model, const PlatformStyle *platformStyle, QString strIdentityPeg, QString identity, QString offer, QString quantity, QString notes, QString title, QString currencyCode, QString sysPrice, QString sellerIdentity, QString address, QString arbiter, QWidget *parent=0);
